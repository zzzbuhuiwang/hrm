...
import com.jaden.hrm.common.entity.PageResult;
...
import com.jaden.hrm.domain.system.response.ProfileResult;
...
public class UserController extends BaseController {
    ...
    public Result findAll(int page, int size, @RequestParam Map map) {
        ...
        //2.完成查询
        Page<User> pageUser = userService.findPage(map,page,size);
        //3.构造返回结果
